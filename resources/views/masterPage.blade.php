...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <footer>
        ...
        <button type="button" class="redes" style="background:grey; margin-right:10px" onclick="window.location='{{url('/info')}}'"> <i class="bi bi-info"></i></button>
                ...
                <button type="button" class="redes" style="background:green; margin-left:10px" onclick="window.location='{{url('/contactUs')}}'"=> <i class="bi bi-envelope"></i></button>
        </div>                
    </footer>
</html>