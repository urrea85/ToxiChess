    ...
    <div class="row justify-content-center" style="margin-top: 10%">
        <div class="col-md-8">
            <div class="card" style=" border-color: black;">
                <div class="card-header" style="background-color: var(--mainColor); border-color: black;">{{ __('Register') }}</div>

                <div class="card-body" style="background: #baadd9;border-color: black;">
